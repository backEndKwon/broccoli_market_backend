...
router.get("/sold", mypageController.getMySoldProducts);

// GET: 관심 목록 조회(본인이 좋아요 누른)
router.get("/likes", mypageController.getMyLikeProducts);

// GET: 자신이 (is_sold:false)구매 확정한 내역
router.post("/buy", mypageController.getMyBuyProducts);
